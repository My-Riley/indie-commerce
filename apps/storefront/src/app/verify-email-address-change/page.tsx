...
export const metadata: Metadata = {
    ...
    description: 'Verify your email address change to complete the update.',
};

async function VerifyEmailAddressChangeContent({
    searchParams,
}: {
...
export default async function VerifyEmailAddressChangePage({
    searchParams,
}: PageProps<'/verify-email-address-change'>) {
    return (
        <div className="flex min-h-screen items-center justify-center px-4">
            <div className="w-full max-w-md space-y-6">
                ...
                >
                    <VerifyEmailAddressChangeContent searchParams={searchParams} />
                </Suspense>
            </div>
        </div>
    );
